          ...
          <a href="{{ url('admin/dashboard') }}">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                      ...
                      <li class="nav-item dropdown">
                         ...
                         <li class="{{ Route::currentRouteNamed('task') ? 'active' : '' }}"><a href="{{ route('task') }}"><span>Tasks</span></a></li> 
          ...
          <a href="{{ url('user/dashboard') }}">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                      ...
                      <li class="nav-item dropdown">
                         ...
                         <li class="{{ Route::currentRouteNamed('logout_user') ? 'active' : '' }}"><a href="{{ route('logout_user') }}"> <span>Logout</span></a></li>
                    </li>
      </ul>
